...
def test_asymptotic_ci(
        X, Y, Z, rank=1000, rank_GP=200, J=5, p_norm=2, mu=1e-10, alpha=0.05, optimizer=True
):
    """
    ...
    :param Y:
    :param Z:
    :param rank: the larger the rank, the less TypeⅠ error while the TypeⅡ error stays the same
    :param rank_GP:
    :param J: the performance do not necessarily increase as J increases
    :param p_norm: proposed method is robust to the choice of p_norm
    :param mu:
